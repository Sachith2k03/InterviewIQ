  ...
  if (error || !dashboard) {
    return (
      <div className="rounded-xl border border-red-500/20 bg-red-500/10 p-5">
        <h1 className="font-medium text-red-300">Dashboard unavailable</h1>
  ...
  const statistics = [
    ...
    },
    {
      ...
      value: `${dashboard.current_streak} ${
        dashboard.current_streak === 1 ? "day" : "days"
      }`,
  ...
  return (
    <div className="mx-auto w-full max-w-7xl space-y-5">
      ...
      <section className="grid gap-5 xl:grid-cols-[minmax(0,1.7fr)_minmax(300px,0.8fr)]">
        ...
        <RecentInterviewCard interview={dashboard.recent_interview} />
      </section>
    </div>
  );
}
